...
/**
 * BidModal — shown when a freelancer clicks "Place Bid" on a project card.
 * Props:
 *   open        {boolean}        Whether the modal is visible
 *   project     {{ projectId, projectTitle }} | null
 *   onClose     {() => void}
 *   onSubmit    {(projectId, amount) => Promise<void>}
 */
      ...
      >
        {done ? (
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: '#1a1a1a' }}>Bid Submitted!</div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <button
                  ...
                  style={{
                    flex: 2, padding: '11px',
                    background: submitting || !amount ? '#fdba74' : '#f97316',
                    border: 'none', borderRadius: 8, cursor: submitting || !amount ? 'not-allowed' : 'pointer',
